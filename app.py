...
<head>
    ...
    <style>
        :root {
            ...
            --md-sys-color-secondary-container: #e0edff;
        ...
        .m3-header-icon-pill:hover, .m3-header-icon-pill:active {
            background-color: #cee5ff;
            color: #001d33;
        }
        .m3-header-icon-pill.danger {
    ...
    <header class="m3-top-app-bar mb-3">
        <div class="container d-flex flex-column gap-2">
            <a href="/" class="text-decoration-none d-flex align-items-center gap-3">
                ...
                {% else %}
                    <div style="width: 44px; height: 44px; background: #e0edff; border-radius: 12px; display: inline-flex; align-items: center; justify-content: center;">
                        <span class="material-symbols-rounded text-primary fs-3">domain</span>
                    </div>
                {% endif %}
                <div>
                    <h5 class="fw-bold mb-0 text-dark">{{ cfg['nome_empresa'] }}</h5>
                    <span class="text-muted" style="font-size: 0.72rem; letter-spacing: 0.5px;">{{ cfg['subtitulo'] or 'Gestão Operacional de Serviços' }}</span>
                </div>
            </a>
            ...
            <div class="d-flex align-items-center gap-2 pt-1 flex-wrap">
                ...
                <a href="/logout" class="m3-header-icon-pill danger" title="Encerrar Sessão">
    ...
    <div class="col-12 col-md-8 col-lg-7">
        <div class="m3-card p-4 p-md-5">
            <div class="d-flex align-items-center gap-3 mb-4">
                <div style="width: 44px; height: 44px; background: #cee5ff; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                    <span class="material-symbols-rounded text-primary fs-3">add</span>
                </div>
                <div>
                    <h4 class="fw-bold mb-0 text-dark">Nova Requisição</h4>
                    <span class="text-muted small">Adicione o local, descrição e foto do problema</span>
                </div>
            </div>
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-between align-items-center pt-2">
                    ...
                    <button type="submit" class="m3-btn-filled">
                        <span class="material-symbols-rounded">send</span> Publicar Chamado
                    </button>
                </div>
            </form>
        </div>
                ...
                <tr>
                    <td colspan="6" class="text-center py-5 text-muted">
                        <div class="my-3">
                            ...
                            <div class="text-secondary fw-semibold">Nenhuma manutenção preventiva cadastrada</div>
                            <small class="text-muted">Crie uma nova rotina para automatizar seu cronograma.</small>
                        </div>
                    </td>
                </tr>
                {% endfor %}
